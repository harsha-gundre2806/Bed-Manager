...
export default function PatientDashboard() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'create':
        return <CreateProfile onSuccess={() => setActiveTab('overview')} />;
      case 'edit':
        return <EditProfile onSuccess={() => setActiveTab('overview')} />;
      case 'complaint':
        return <RaiseComplaint onSuccess={() => setActiveTab('overview')} />;
      case 'rate':
        return <RateStaff onSuccess={() => setActiveTab('overview')} />;
      case 'request':
        return <ServiceRequest onSuccess={() => setActiveTab('overview')} />;
      default:
        return (
